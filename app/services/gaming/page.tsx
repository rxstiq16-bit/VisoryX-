...
import { Gamepad2, Check, ArrowUpRight, ArrowLeft } from "lucide-react"

const deliverables = [
  "ERLC liveries (LEO, Fire Department, Civilian, DoT)",
  "Multi-vehicle fleet packs (3-vehicle and 5-vehicle bundles)",
  "Stream overlay packages (webcam frame, alerts, panels, screens)",
  "YouTube thumbnail packs (5 or 10 templates)",
  "Esports team kits (logo, jersey mockup, banner, social headers)",
  "FiveM vehicle wraps & server loading screens",
]

const process = [
  { step: "01", title: "Brief", desc: "Tell us the vehicle, game, or platform. Share references, colors, and any specific requirements." },
  { step: "02", title: "Design", desc: "We create your livery, overlay, or graphics with attention to every pixel and in-game constraint." },
  { step: "03", title: "Review", desc: "Preview your designs with in-context mockups. Request changes until everything is exactly right." },
  { step: "04", title: "Deliver", desc: "Receive game-ready files, layered source files, and installation instructions for your platform." },
]
    ...
    <main>
      ...
      <section ref={heroRef} className="relative overflow-hidden pt-40 pb-24 lg:pt-52 lg:pb-32">
        <div className="pointer-events-none absolute inset-0 -z-10">
          <div className="absolute top-1/4 left-1/4 h-[60vh] w-[60vh] rounded-full bg-emerald-500/[0.05] blur-[200px]" />
          <div className="absolute bottom-0 right-1/3 h-[40vh] w-[40vh] rounded-full bg-green-500/[0.04] blur-[150px]" />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className={cn("flex items-center gap-5 mb-8", heroVisible && "animate-reveal-up stagger-1")}>
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-medium italic text-primary/70">Pixel-perfect for every platform.</p>
            </div>
          </div>

          <div className="flex items-start gap-8">
            <p className={cn("max-w-2xl text-lg text-muted-foreground leading-relaxed", heroVisible && "animate-reveal-up stagger-2")}>
              ERLC liveries, FiveM wraps, stream overlays, YouTube thumbnails, esports team kits -- if it involves gaming or content creation, we design it. Single vehicles to full fleet packages, webcam frames to complete overlay suites.
            </p>
            <img
          ...
          <div className={cn("mt-10 flex flex-wrap gap-4", heroVisible && "animate-reveal-up stagger-3")}>
            <Link href="/pricing#gaming" className="magnetic-btn inline-flex items-center gap-2 rounded-full bg-primary px-7 py-3 text-sm font-bold uppercase tracking-[0.1em] text-primary-foreground transition-all hover:brightness-110">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            <div className={cn(contentVisible && "animate-reveal-up")}>
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">Game-ready assets designed for ERLC, FiveM, Roblox, streaming platforms, and esports teams.</p>
            ...
            <div className={cn(contentVisible && "animate-reveal-up stagger-2")}>
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">From brief to game-ready files, optimized for your specific platform and constraints.</p>
